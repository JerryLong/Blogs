...
<@head title="${post.postTitle} · ${options.blog_title?default('Blogs')}" keywords="${post.postTitle},${options.seo_keywords?default('Blogs')}" description="${post.postSummary?if_exists}"></@head>
