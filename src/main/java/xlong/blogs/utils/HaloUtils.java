...
import xlong.blogs.model.dto.BackupDto;
import xlong.blogs.model.dto.BlogConst;
import xlong.blogs.model.dto.Theme;
import xlong.blogs.model.enums.BlogPropertiesEnum;
import xlong.blogs.model.enums.CommonParamsEnum;
...
public class HaloUtils {
    ...
    public static List<BackupDto> getBackUps(String dir) {
        String srcPathStr = System.getProperties().getProperty("user.home") + "/blogs/backup/" + dir;
    ...
    public static String getRss(List<Post> posts) throws FeedException {
        ...
        if (null == BlogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_TITLE.getProp())) {
            channel.setTitle("");
        } else {
            channel.setTitle(BlogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_TITLE.getProp()));
        }
        if (null == BlogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp())) {
            channel.setLink("");
        } else {
            channel.setLink(BlogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()));
        }
        if (null == BlogConst.OPTIONS.get(BlogPropertiesEnum.SEO_DESC.getProp())) {
            channel.setDescription("");
        } else {
            channel.setDescription(BlogConst.OPTIONS.get(BlogPropertiesEnum.SEO_DESC.getProp()));
        }
        ...
        for (Post post : posts) {
            ...
            item.setLink(BlogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()) + "/archives/" + post.getPostUrl());
    ...
    public static String getSiteMap(List<Post> posts) {
        ...
        String urlBody = "";
        String urlItem;
        String urlPath = BlogConst.OPTIONS.get(BlogPropertiesEnum.BLOG_URL.getProp()) + "/archives/";
        for (Post post : posts) {
