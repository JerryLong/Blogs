package xlong.blogs.web.controller.core;
...
import xlong.blogs.model.domain.*;
import xlong.blogs.model.dto.BlogConst;
import xlong.blogs.model.dto.LogsRecord;
import xlong.blogs.model.enums.AllowCommentEnum;
import xlong.blogs.model.enums.BlogPropertiesEnum;
import xlong.blogs.model.enums.TrueFalseEnum;
import xlong.blogs.service.*;
...
public class InstallController {
    ...
    public String install(Model model) {
        try {
            if (StringUtils.equals(TrueFalseEnum.TRUE.getDesc(), BlogConst.OPTIONS.get(BlogPropertiesEnum.IS_INSTALL.getProp()))) {
...
//            post.setPostSummary("欢迎使用Blog进行创作，删除这篇文章后赶紧开始吧。");
